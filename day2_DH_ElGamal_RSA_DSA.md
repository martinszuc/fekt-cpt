...
> You need [[day1_groups_phi_generators]] (ϕ(n), modular inverse, orders) to follow this. Make sure you're comfortable with modular inverse — it appears constantly here.
...
> 
> An eavesdropper sees g, p, A, B — but cannot compute g^(ab) without knowing a or b. This is the **Discrete Logarithm Problem**.
...
> [!note] Teacher note
> "In this protocol, q can be any divisor of p-1."
...
> [!tip] Exam note
> The question usually gives you g directly. The key skill is computing A, B, K — not finding g from scratch.
...
K_Bob   = A^b = 5^3 mod 11 = 125 mod 11 = 125-121 = 4 ✓
```
...
ElGamal is Diffie-Hellman applied to encryption.
...
> [!note] Why it works
> c^d = m^(ed) ≡ m^1 = m mod n (by Euler's theorem, since ed ≡ 1 mod ϕ(n))

> [!important] Common RSA mistakes
> - d is found mod **ϕ(n)**, not mod n
> - e must satisfy gcd(e, ϕ(n)) = 1 — use [[gcd]] to verify
...
> [!note]
> In this example d = e = 5. This happens sometimes with small numbers — it's a coincidence, not the general case.
...
m = 8^7 mod 33
8^2 = 64 ≡ 31 mod 33
8^4 = 31^2 = 961 ≡ 4 mod 33
8^7 = 8^4 · 8^2 · 8 = 4·31·8 = 992 ≡ 2 mod 33
...
> [!tip] Exam likelihood
> Less likely to be computed in full on the exam, but you need to know the flow and be able to follow the steps if given.
...
B = 5^15 mod 23
5^8 = (5^4)^2 = 4^2 = 16
5^15 = 5^8·5^4·5^2·5 = 16·4·2·5 = 640 mod 23 = 19
B = 19

K = 8^15 mod 23 = 2   (trust the math — both sides give same result)

Encrypt: c = 2·4 + 2 = 10 mod 23

Decrypt: m = (c - K) · 2⁻¹ mod 23 = (10-2) · 12 = 96 mod 23 = 4 ✓
(2⁻¹ mod 23: 2·12=24≡1, so 2⁻¹=12)
```
...
**Previous:** [[day1_groups_phi_generators]] | **Next:** [[day3_elliptic_curves]]
